...
log10 (float64_t x)
{
	...
	float64_t hfsq,f,s,z,R,w,t1,t2,dk,y,hi,lo,val_hi,val_lo;
	uint32_t hx;
	int k;
...
main ()
{
    float64_t vals[32] = {
        ...
        -0x1.02239f3c6a8f1p+3, // ->  nan64
         0x1.161868e18bc67p+2, // ->  0x1.46a9bd1d2eb87p-1
        -0x1.0c34b3e01e6e7p+3, // ->  nan64
        -0x1.a206f0a19dcc4p+2, // ->  nan64
         0x1.288bbb0d6a1e6p+3, // ->  0x1.ef12fff994862p-1
         0x1.52efd0cd80497p-1, // -> -0x1.6ee6db5a155cbp-3
        -0x1.a05cc754481d1p-2, // ->  nan64
         0x1.1f9ef934745cbp-1, // -> -0x1.0075cda79d321p-2
         0x1.8c5db097f7442p-1, // -> -0x1.c75df6442465ap-4
