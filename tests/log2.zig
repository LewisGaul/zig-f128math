...
const TestcaseLog2_32 = test_util.Testcase(math.log2, "log2", .Binary32);
const TestcaseLog2_64 = test_util.Testcase(math.log2, "log2", .Binary64);
const TestcaseLog2_128 = test_util.Testcase(math.log2, "log2", .Binary128);
